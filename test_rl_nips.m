...
for i = 1 : 7
    ...
    parfor j = 1 : 20000
        ...
        for v = 1:m
            ...
            current_state(v) = sum(vals);
        end

        %  Quantized State
        [state_hard,qaunts] = quantiz(current_state,partition1{i},codebook1{i});
        ...
        for u = 1:(height(pcmatrix)/BlockSize)*maxnumiter   % number of clusters
            ...
            %  Quantized State
            [state_hard_updated,qaunts] = quantiz(current_state,partition1{i},codebook1{i});

            % Initilization of states for Episode
            s = state_hard_updated + 1;
